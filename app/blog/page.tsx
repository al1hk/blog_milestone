      ...
      <header id="header" className="bg-black text-white p-4 md:p-8">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mb-4 md:hidden">
            <Image id="logo" className='w-16 h-18 md:w-20 md:h-22' src="https://websitedemos.net/love-nature-02/wp-content/uploads/sites/988/2021/11/logo-white.svg" alt="Coffee Logo" width={64} height={72} />
          </div>
      ...
      <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-6">
        ...
        <div className="w-full max-w-3xl">
          <div className="flex justify-center">
            <Image
              src="/assets/Screenshot+2023-07-27+165928.png" // Place an image named 'nature.jpg' in the 'public' folder
              alt="Nature"
              width={800}
              height={500}
